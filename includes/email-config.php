...
define('SMTP_USER', 'EazyHaven'); // Corrected to use a string value
...
define('EMAIL_FROM', 'no-reply@eazyhaven.com');
define('EMAIL_NAME', 'EazyHaven');
define('ADMIN_EMAIL', 'no-reply@eazyhaven.com');
?>